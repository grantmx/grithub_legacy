				...
				<section className={home.heroWrapper}>
					...
					<div className={home.hero}>
						...
						<div className={home.heroPartners}>
							<p className="lead text-white w-100 mb-3">In strategic partnership with</p>
							...
							<div className="col-12 d-flex justify-content-start align-items-center">
								...
								<div className="col-2">
									<Image src="/assets/partners/suff-logo.png" width={150} height={40} alt="SUFF" />
								</div>
								<div className="col-2">
									<svg width="175" height="40" viewBox="0 0 424 158">
