			...
			<main className="container-fluid d-flex p-0 flex-column">
				<div className={home.hero}>
					<nav className="navbar navbar-light w-100 container-xxl">
						<div className="container-fluid d-flex justify-content-between flex-nowrap">
							<a className="navbar-brand" href="#">
								<Image src="/assets/grithub-logo-horz-dark.svg" width={400} height={125} />
							</a>
							<div className={home.navbarNav}>
								<a className="nav-link fs-5 me-5 text-dark" href="#about">
									<Image src="/assets/people.svg" width={20} height={20} className="d-lg-none" />
									About
								</a>
								<a className="nav-link fs-5 me-5 text-dark" href="#incubator">
									<Image src="/assets/sun.svg" width={20} height={20} className="d-lg-none" />
									Incubation
								</a>
								<a className="nav-link fs-5 me-5 text-dark" href="#programs-workshops">
									<Image src="/assets/event_seat.svg" width={20} height={20} className="d-lg-none" />
									Programs
								</a>
								<a className="nav-link fs-5 me-5 text-dark" href="#coworking">
									<Image src="/assets/activity.svg" width={20} height={20} className="d-lg-none" />
									Coworking
								</a>
								<a className="nav-link fs-5 me-5 text-dark" href="#contact">
									<Image src="/assets/mail_outline.svg" width={20} height={20} className="d-lg-none" />
									Contact
								</a>
							</div>
						</div>
					...
					<div className="col-md-7 col-8 ps-5 ">
						...
						<a href="#about" className={home.heroBtn} type="button">Learn more</a>
					</div>
				</div>
					...
					<div className="col-12 d-flex flex-wrap">
						<div className="col-xl-4 col-md-6 col-12 p-4">
							<div className="card shadow-sm h-100">
								<Image src="/assets/workshop-thumb.jpg" width={500} height={333} className={home.cardTopImg} />
								<div className="card-body">
									<h5 className="card-title">Programs &amp; Workshops</h5>
						...
						<div className="col-xl-4 col-md-6 col-12 p-4">
							<div className="card shadow-sm h-100">
								<Image src="/assets/incubator-thumb.jpg" width={500} height={333} className={home.cardTopImg} />
								<div className="card-body">
									<h5 className="card-title">SME and Entrepreneurship Incubation</h5>
						...
						<div className="col-xl-4 col-md-6 col-12 p-4">
							<div className="card shadow-sm h-100">
								<Image src="/assets/office-space-thumb.jpg" width={500} height={333} className={home.cardTopImg} />
								<div className="card-body">
									<h5 className="card-title">Coworking Spaces</h5>
						...
						<div className="d-md-flex d-xs-none d-xl-none col-xl-4 col-md-6 col-12 p-md-5 p-4 justify-content-center flex-column align-item-center">
							<h5 className="display-6 fw-bold">We strive for wholistic change at every level of South Africa.</h5>
					...
					<div className="col-12  d-flex justify-content-between flex-wrap">
						<div className="col-xl-4 col-md-6 col-12 p-md-5 p-3">
							<div className="card shadow h-100">
								<Image src="/assets/power.svg" width={150} height={150} className={home.cardTopOverflow} />
								<div className="card-body">
									<h5 className="card-title fw-bold">SME Digital Transformation &amp; Coaching</h5>
									...
									<a href="/papers/eBook-SMB-of-the-Future-FINAL-2019-07-29.pdf" target="_blank" rel="noreferrer noopener">White Paper: 7 Trends Driving SMEs’ Digital Transformation &rsaquo;</a>
								</div>
							</div>
						</div>
						...
						<div className="col-xl-4 col-md-6 col-12 p-md-5 p-3">
							<div className="card shadow h-100">
								<Image src="/assets/worker.svg" width={150} height={150} className={home.cardTopOverflow} />
								<div className="card-body">
									<h5 className="card-title fw-bold">Digital Skills &amp; Apprenticeships</h5>
									...
									<a href="/papers/skills_boost_western_cape_-_summary_report.pdf" target="_blank" rel="noreferrer noopener">White Paper: Western Cape Digital Skills Shared Agenda for Action &rsaquo;</a>
								</div>
							</div>
						</div>
						...
						<div className="col-xl-4 col-md-6 col-12 p-md-5 p-3">
							<div className="card shadow h-100">
								<Image src="/assets/3d-printer.svg" width={150} height={150} className={home.cardTopOverflow} />
								<div className="card-body">
									<h5 className="card-title fw-bold">FabLab Innovation Centre</h5>
									<p className="card-text">Disruptive Technologies like "Additive Manufacturing" or 3D Printing paired with the sharp removal of it's price barrier allows young entrepreneurs to enter previously closed markets. Our <a href="https://fabfoundation.org/" target="_blank" rel="noreferrer noopener">FabLab</a> will assist in product development, rapid tooling and prototyping as well as learning new business models.</p>
									<a href="/papers/1-s2.0-S0040162520313093-main.pdf" target="_blank" rel="noreferrer noopener">White Paper: The Effect of 3D Printing Technologies on Entrepreneurship &rsaquo;</a>
								</div>
							</div>
						</div>
						...
						<div className="d-md-flex d-xs-none d-xl-none col-xl-4 col-md-6 col-12 p-md-5 p-3  justify-content-center flex-column align-item-center">
							<h5 className="display-6 fw-bold text-white">...And more bespoke programs to meet your industry needs</h5>
					...
					<div className="col-12 d-flex justify-content-between flex-wrap">
						...
						<div className="col-xl-4 col-md-6 col-12 p-md-5 p-3">
							<div className="card shadow-sm position-relative h-100">
								...
								<Image src="/assets/atom.svg" width={150} height={150} className={home.cardTopOverflow} />
								<div className="card-body">
									<h5 className="card-title fw-bold">Science, Technology, Engineering and Mathematics (STEM)</h5>
									...
									<a href="/papers/1-s2.0-S2468227619307616-main.pdf" target="_blank" rel="noreferrer noopener">White Paper: Engineering education, development and growth in Africa &rsaquo;</a>
								</div>
							</div>
						</div>
						...
						<div className="col-xl-4 col-md-6 col-12 p-md-5 p-3">
							<div className="card shadow-sm position-relative h-100">
								<div className={`${ribbon.ribbon_top_right} ${ribbon.ribbon__green}`}><span>STEM</span></div>
								<Image src="/assets/lego.svg" width={150} height={150} className={home.cardTopOverflow} />
								<div className="card-body">
									<h5 className="card-title fw-bold">LEGO&reg; STEM Learning</h5>
									...
									<a href="/papers/le_learning_through_play_whitepaper_digital_pdf.pdf" target="_blank" rel="noreferrer noopener" className="card-link">White Paper: LEGO&reg; Education - The unrealized potential of learning through play at school &rsaquo;</a>
								</div>
							</div>
						</div>
						...
						<div className="col-xl-4 col-md-6 col-12 p-md-5 p-3">
							...
							<Image src="/assets/programmer.svg" width={150} height={150} className={home.cardTopOverflow} />
								<div className="card-body">
									<h5 className="card-title fw-bold">Code &amp; Enterprise Hackathons</h5>
									...
									<a href="/papers/Demystifying_the_hackathon.pdf" target="_blank" rel="noreferrer noopener">White Paper: Demystifying The Hackathon &rsaquo;</a>
								</div>
							</div>
						</div>
						...
						<div className="col-xl-4 col-md-6 col-12 p-md-5 p-3">
							<div className="card shadow-sm position-relative h-100">
								...
								<Image src="/assets/healthcare.svg" width={150} height={150} className={home.cardTopOverflow} />
								<div className="card-body">
									<h5 className="card-title fw-bold">Public Health Technology</h5>
									...
									<a href="/papers/Materilie345_digital_health_africa.pdf" target="_blank" rel="noreferrer noopener">White Paper: Digital Health Ecosystem for African Countries &rsaquo;</a>
								</div>
							</div>
						</div>
						...
						<div className="col-xl-4 col-md-6 col-12 p-md-5 p-3">
							<div className="card shadow-sm position-relative h-100">
								<div className={`${ribbon.ribbon_top_right}`}><span>Program</span></div>
								<Image src="/assets/game-pad.svg" width={150} height={150} className={home.cardTopOverflow} />
								<div className="card-body">
									<h5 className="card-title fw-bold">Roblox&reg; Game Engineering</h5>
									...
									<a href="/papers/1-s2.0-S1071581920300987-main.pdf" target="_blank" rel="noreferrer noopener">White Paper: The Effect of Challenge-Based Gamification on Learning &rsaquo;</a>
								</div>
							</div>
						</div>
						...
						<div className="col-xl-4 col-md-6 col-12 p-md-5 p-3">
							<div className="card shadow-sm position-relative h-100">
								<div className={`${ribbon.ribbon_top_right}`}><span>Program</span></div>
								<Image src="/assets/tractor.svg" width={150} height={150} className={home.cardTopOverflow} />
								<div className="card-body">
									...
									<a href="/papers/1-s2.0-S2211912419301804-main.pdf" target="_blank" rel="noreferrer noopener">White Paper: The Game-Changing Technologies of Agriculture 4.0 &rsaquo;</a>
								</div>
							</div>
						</div>
				...
				<section className="container-fluid d-flex justify-content-between align-items-center pt-5 flex-column bg-secondary bg-gradient" id="coworking">
					<div className="col-12 d-flex align-items-center flex-column">
						...
						<div className="col-12 d-flex flex-wrap">
							<div className="col-xl-3 col-md-6 col-12 p-4 d-flex flex-column">
								<Image src="/assets/wifi_tethering.svg" width={50} height={50} className={home.whiteIcon} />
								<p className="lead text-white pt-3">Fast ultra 1,000 Mbps Fiber. Audio, Video and Podcasting Equipment. Charging Stations.</p>
							</div>
							<div className="col-xl-3 col-md-6 col-12 p-4 d-flex flex-column">
								<Image src="/assets/presentation.svg" width={50} height={50} className={home.whiteIcon} />
							...
							<div className="col-xl-3 col-md-6 col-12 p-4 d-flex flex-column">
								<Image src="/assets/build.svg" width={50} height={50} className={home.whiteIcon} />
							...
							<div className="col-xl-3 col-md-6 col-12 p-4 d-flex flex-column">
								<Image src="/assets/airport_shuttle.svg" width={50} height={50} className={home.whiteIcon} />
							...
							<div className="col-xl-3 col-md-6 col-12 p-4 d-flex flex-column">
								<Image src="/assets/child_friendly.svg" width={50} height={50} className={home.whiteIcon} />
							...
							<div className="col-xl-3 col-md-6 col-12 p-4 d-flex flex-column">
								<Image src="/assets/laptop_mac.svg" width={50} height={50} className={home.whiteIcon} />
							...
							<div className="col-xl-3 col-md-6 col-12 p-4 d-flex flex-column">
								<Image src="/assets/fingerprint.svg" width={50} height={50} className={home.whiteIcon} />
							...
							<div className="col-xl-3 col-md-6 col-12 p-4 d-flex flex-column">
								<Image src="/assets/local_cafe.svg" width={50} height={50} className={home.whiteIcon} />
					...
					<div className="col-12 d-flex justify-content-center">
						<Image src="/assets/4890818.png" width={1500} height={495} />
					</div>
				</section>
			</main>
			...
			<footer className="col-12 d-flex flex-wrap justify-content-center" id="contact">
				...
				<div className="col-12 col-md-7 d-flex flex-wrap">
					...
					<div className="col-md-6 col-12 d-flex p-4 flex-column justify-content-start">
						<Image src="/assets/grithub-logo-horz-dark.svg" width={300} height={100} />
					...
					<div className="col-md-6 col-12 p-4 d-flex justify-content-center align-items-center flex-column">
						...
						<button type="button" className="btn px-1 d-flex justify-content-center align-item-center">
							<Image src="/assets/whatsapp.svg" width={25} height={25} />
							<small className="ms-2">+27 (063) 070 5752</small>
						</button>
						<button type="button" className="btn px-1 d-flex justify-content-center align-item-center">
							<Image src="/assets/phone.svg" width={25} height={25} />
							<small className="ms-2">+27 (076) 282 2192</small>
						</button>
						<button type="button" className="btn px-1 d-flex justify-content-center align-item-center">
							<Image src="/assets/mail_outline.svg" width={25} height={25} />
				...
				<div className="col-12 p-2 border-top mt-2 text-center">
					<small className="text-muted" style={{fontSize: "11px"}}>
						Attributions: &nbsp;
						<a className="text-muted" target="_blank" href='https://www.freepik.com/photos/city' rel="noreferrer noopener nofollow">Way Home Studio</a>, &nbsp;
						<a className="text-muted" href='https://www.freepik.com/vectors/abstract' rel="noreferrer noopener nofollow">Starline</a>, &nbsp;
						<a className="text-muted" href='https://www.freepik.com/vectors/office' rel="noreferrer noopener nofollow">Piki Super Star</a>, &nbsp;
						<a className="text-muted" href="https://www.freepik.com/photos" title="Freepik" rel="noreferrer noopener nofollow">Freepik Photos</a>, &nbsp;
						<a className="text-muted" href="https://www.flaticon.com/" title="Flaticon" rel="noreferrer noopener nofollow">Freepik Icons</a>
					</small>
				</div>
			</footer>
		</>
