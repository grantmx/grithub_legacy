                ...
                <div className="col-xl-4 col-md-6 col-12 p-md-5 p-3">
                    <div className="card shadow-sm position-relative h-100">
                        <div className="card-body d-flex flex-column justify-content-between text-center">
                            ...
                            <p>Internet TV is here to stay.  With open source streaming players like <a href="https://blog.roku.com/blog/2014/09/16/10-million-roku-players-sold/" target="_blank" rel="no-follow">Roku</a>, AppleTV and Amazon Fire in over 70 Million homes across the US, it's time for your online video content to break free of your website and <a href="https://grithub-za-1.hubspotpagebuilder.com/contact-us" className="cta-modal" title="get your organization on TV">reach more customers</a>.</p>
                        </div>
                    </div>
                </div>
